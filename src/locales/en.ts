...
export const en: Record<string, string> = {
  ...
  "topbar.transcoding": "transcoding",
  ...
  "dl.queue.hint": "Paste one URL per line, then hit Queue all. Each downloads at the best available video + audio (mp4). {n} downloads run in parallel; transcodes serialize (the CPU and GPU pools run independently, so a libx264 job and an NVENC job can overlap). The queue survives app restarts.",
  "dl.audioMode": "audio mode",
  "dl.audioOff": "Off (video)",
  "dl.audioHintVideo": "video downloads — the transcode below applies",
  "dl.audioHintExtract": "extract audio to .{ext} (transcode ignored)",
  "dl.transcodeAll": "transcode all",
  "dl.queueIntoLibrary": "Queue into Library (Ctrl held)",
  "dl.qActive": "{n} active",
  "dl.qQueued": "{n} queued",
  "dl.qDone": "{n} done",
  "dl.qFailed": "{n} failed",
  "dl.qCanceled": "{n} canceled",
  // Transcode presets — shown on the Download page, Settings, Onboarding
  // and the library right-click menu.
  "preset.none": "None",
  "preset.none.hint": "keep source as-is",
  "preset.prores_422_lt": "ProRes 422 LT",
  "preset.prores_422_lt.hint": ".mov · NLE-friendly · ~100 Mbps · default for editing",
  "preset.dnxhr_sq": "DNxHR SQ",
  "preset.dnxhr_sq.hint": ".mov · Avid-native intermediate",
  "preset.h264_mp4": "H.264 MP4 (optimized)",
  ...
  "lib.importDrop": "Drop to import into the library",
  "lib.importing": "Importing {n}…",
  "lib.copiedN": "Copied {n} to clipboard",
  "lib.cutN": "Cut {n} — paste to move",
