...
export async function enqueue({ url, token, target, audioFormat, projectId, source, cookies, quality, transcode, rename, mediaIndex }) {
  ...
  // 1.13.x — 1-based media item for multi-video posts (see content-twitter).
  if (Number.isInteger(mediaIndex) && mediaIndex >= 1) body.media_index = mediaIndex;
