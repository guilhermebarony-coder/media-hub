...
pub(crate) async fn yt_dlp_capture(
    app: &AppHandle,
    opts: &[String],
    cookie_args: &[String],
    url: &str,
...
/// attempts.
pub(crate) fn js_runtime_args(app: &AppHandle) -> Vec<String> {
...
pub(crate) fn resolve_cookie_args(
    app: &AppHandle,
...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            preview::preview_intra_window,
            preview::preview_cache_info,
            preview::preview_cache_clear,
            yt_download,
            yt_download_cancel,
            mouse_cursor_pos,
            os_open_path,
